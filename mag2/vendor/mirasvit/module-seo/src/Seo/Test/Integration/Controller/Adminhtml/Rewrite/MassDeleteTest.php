...
class MassDeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/seo/rewrite/massdelete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Seo\Controller\Adminhtml\Rewrite\MassDelete::execute
     */
    public function testMassDeleteAction()
    {
        $this->dispatch('backend/seo/rewrite/massdelete');
