...
class MassDisableTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/seo/redirect/massdisable';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Seo\Controller\Adminhtml\Redirect\MassDisable::execute
     */
    public function testMassDisableAction()
    {
        $this->dispatch('backend/seo/redirect/massdisable');
