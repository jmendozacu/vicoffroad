...
class MassEnableTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/seo/redirect/massenable';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Seo\Controller\Adminhtml\Redirect\MassEnable::execute
     */
    public function testMassEnableAction()
    {
        $this->dispatch('backend/seo/redirect/massenable');
