...
class MassStatusTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/seo/rewrite/massstatus';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Seo\Controller\Adminhtml\Rewrite\MassStatus::execute
     */
    public function testMassStatusAction()
    {
        $this->markTestIncomplete();

        $this->dispatch('backend/seo/rewrite/massstatus');
