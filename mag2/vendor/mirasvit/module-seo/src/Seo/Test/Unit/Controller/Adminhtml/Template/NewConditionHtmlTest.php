...
namespace Mirasvit\Seo\Test\Unit\Controller\Adminhtml\Template;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Seo\Controller\Adminhtml\Template\NewConditionHtml
 *
...
class NewConditionHtmlTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Seo\Controller\Adminhtml\Template\NewConditionHtml|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        $this->templateFactoryMock = $this->getMock(
            '\Mirasvit\Seo\Model\TemplateFactory',
            ['create'],
            [],
            '',
            false
        ...
        $this->templateController = $this->objectManager->getObject(
            '\Mirasvit\Seo\Controller\Adminhtml\Template\NewConditionHtml',
            [
