...
/**
 * @covers \Mirasvit\Seo\Controller\Adminhtml\Rewrite
 *
...
class RewriteTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Seo\Controller\Adminhtml\Rewrite|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    {
        $this->rewriteFactoryMock = $this->getMock('\Mirasvit\Seo\Model\RewriteFactory', ['create'], [], '', false);
        $this->rewriteMock = $this->getMock('\Mirasvit\Seo\Model\Rewrite', ['load', 'save', 'delete'], [], '', false);
        ...
        $this->rewriteController = $this->getMockForAbstractClass(
            '\Mirasvit\Seo\Controller\Adminhtml\Rewrite',
            [
