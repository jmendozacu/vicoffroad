...
class DeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/seoautolink/link/delete';
        parent::setUp();
    }
     ...
     *
     * @covers  Mirasvit\SeoAutolink\Controller\Adminhtml\Link\Delete::execute
     */
    public function testDeleteAction()
    {
        $this->getRequest()->setParam('id', 5);
        $this->dispatch('backend/seoautolink/link/delete');
        $this->assertNotEquals('noroute', $this->getRequest()->getControllerName());
        $this->assertTrue($this->getResponse()->isRedirect());
        $this->assertSessionMessages(
            $this->equalTo(['Item was successfully deleted']),
