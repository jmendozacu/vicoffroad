...
class MassDeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/seoautolink/link/massdelete';
        parent::setUp();
    }
     ...
     *
     * @covers  Mirasvit\SeoAutolink\Controller\Adminhtml\Link\MassDelete::execute
     */
    public function testMassDeleteAction()
    {
        $this->getRequest()->setParam('link_id', [5]);
        $this->dispatch('backend/seoautolink/link/massdelete');
