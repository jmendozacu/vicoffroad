...
namespace Mirasvit\SeoAutolink\Test\Unit\Controller\Adminhtml;
 ...
 *
 * @covers \Mirasvit\SeoAutolink\Controller\Adminhtml\Link
 */
class LinkTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\SeoAutolink\Controller\Adminhtml\Link|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    {
        $this->linkFactoryMock = $this->getMock('\Mirasvit\SeoAutolink\Model\LinkFactory', ['create'], [], '', false);
        ...
        $this->linkController = $this->getMockForAbstractClass(
            '\Mirasvit\SeoAutolink\Controller\Adminhtml\Link',
            [
    ...
    {
        $this->assertEquals($this->linkController, $this->linkController);
    }
}
