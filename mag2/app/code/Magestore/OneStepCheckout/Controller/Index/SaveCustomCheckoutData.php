...
class SaveCustomCheckoutData extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $this->_objectManager->get('Magento\Checkout\Model\Session')->setCreateCustomer( $additionalData->getData('create_customer'));
        $this->_objectManager->get('Magento\Checkout\Model\Session')->setPassword($additionalData->getData('password')); 
    }
}