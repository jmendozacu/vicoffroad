...
class Removeimg extends Copyimg
{
    public function __construct(
        ...
        parent::__construct($helper, $objectManager, $catalogProductMediaConfig, $fileStorageDb, $attributeCollectionFactory, $mediaConfig, $eavConfig, $filesystem, $resource);
    ...
    protected function _removeData($attrId, $productId, $product, $imageAttr)
    {
        ...
        $varcharTable = $this->connection->getTableName('catalog_product_entity_varchar');
        ...
        $select = $db->select()
            ...
            ->joinInner(
                ['entity' => $this->connection->getTableName(\Magento\Catalog\Model\ResourceModel\Product\Attribute\Backend\Media::GALLERY_VALUE_TO_ENTITY_TABLE)],
        ...
        // Delete labels
        $tableLabels = $this->connection->getTableName('catalog_product_entity_media_gallery_value');
