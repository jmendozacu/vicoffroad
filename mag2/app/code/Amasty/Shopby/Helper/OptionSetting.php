...
class OptionSetting extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(Context $context, CollectionFactory $optionCollectionFactory, Shopby\Model\OptionSettingFactory $settingFactory, Repository $repository)
    {
